...
class PixibbBrowseProvider extends ChangeNotifier {
  ...
  PixibbCategory _currentCategory = PixibbCategory.all;
  ...
  PixibbCategory get currentCategory => _currentCategory;
  ...
  Future<void> loadPage(int page) async {
    ...
    try {
      final response = await PixibbApiService.fetchPageData(
        page: page,
      ...
      if (response != null) {
        ...
        _errorMessage = '获取 PixiBB 列表失败，请检查网络或配置代理';
      }
    } catch (e) {
      if (requestId != _currentRequestId) return;
  ...
  void switchCategory(PixibbCategory category) {
