...
class CosplayporntubeBrowseProvider extends ChangeNotifier {
  ...
  CosplayporntubeCategory _category = CosplayporntubeCategory.trending;
  ...
  CosplayporntubeCategory get category => _category;
  ...
  CosplayporntubeBrowseProvider({bool autoLoad = false}) {
    if (autoLoad) {
      loadPage(1);
    }
  }
  ...
  void selectCategory(CosplayporntubeCategory cat) {
  ...
  Future<void> loadPage(int page) async {
    ...
    try {
      final pageData = await CosplayporntubeApiService.fetchPageData(
        page: page,
        category: _category,
