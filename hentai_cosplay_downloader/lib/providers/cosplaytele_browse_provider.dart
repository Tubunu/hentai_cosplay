...
class CosplayteleBrowseProvider extends ChangeNotifier {
  ...
  CosplayTeleCategory _currentCategory = CosplayTeleCategory.latest;
  ...
  CosplayTeleCategory get currentCategory => _currentCategory;
  ...
  Future<void> loadPage(int page) async {
    ...
    try {
      final response = await CosplayteleApiService.fetchPageData(
        page: page,
  ...
  void switchCategory(CosplayTeleCategory category) {
