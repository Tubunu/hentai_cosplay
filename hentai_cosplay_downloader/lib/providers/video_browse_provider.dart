...
class VideoBrowseProvider extends ChangeNotifier {
  ...
  VideoCategory get category => _category;
  ...
  void toggleVideoSelection(VideoItem item) {
  ...
  bool isVideoSelected(VideoItem item) {
    final key = item.slug.isNotEmpty ? item.slug : item.detailUrl;
    return _selectedSlugs.contains(key);
  }
  ...
  Future<void> loadPage(int page) async {
    ...
    try {
      final res = await VideoApiService.fetchVideoPageData(
        category: _category,
