...
class SpankbangBrowseProvider extends ChangeNotifier {
  ...
  SpankbangCategory _currentCategory = SpankbangCategory.trending;
  ...
  SpankbangCategory get currentCategory => _currentCategory;
  ...
  Future<void> loadPage(int page) async {
    ...
    try {
      final response = await SpankbangApiService.fetchPageData(
        page: page,
      ...
      if (response != null) {
        ...
        _errorMessage = '获取 SpankBang 列表失败，请检查网络或配置代理';
      }
    } catch (e) {
      if (requestId != _currentRequestId) return;
  ...
  void switchCategory(SpankbangCategory category) {
