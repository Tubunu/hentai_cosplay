...
class PornboxBrowseProvider extends ChangeNotifier {
  ...
  PornboxCategory _category = PornboxCategory.latest;
  ...
  PornboxCategory get category => _category;
  String get searchKeyword => _searchKeyword;
  String? get selectedStudio => _selectedStudio;
  bool get isStudioActive => _selectedStudio != null && _selectedStudio!.isNotEmpty;
  ...
  void setCategory(PornboxCategory newCat) {
    _category = newCat;
    _searchKeyword = '';
  ...
  void setSelectedStudio(String studio) {
    _selectedStudio = studio.trim();
    _searchKeyword = '';
    loadPage(1);
  }
  ...
  void resetToLatest() {
    _category = PornboxCategory.latest;
    _searchKeyword = '';
    _selectedStudio = null;
    loadPage(1);
  }
  ...
  Future<void> loadPage(int page) async {
    ...
    try {
      final res = await PornboxApiService.fetchPageData(
        page: page,
        category: _category,
