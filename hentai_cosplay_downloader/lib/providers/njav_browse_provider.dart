...
class NjavBrowseProvider extends ChangeNotifier {
  ...
  NjavCategory _currentCategory = NjavCategory.recentUpdate;
  ...
  NjavCategory get currentCategory => _currentCategory;
  ...
  NjavBrowseProvider({bool autoLoad = true}) {
    if (autoLoad) {
      loadPage(1);
    }
  }

  Future<void> setCategory(NjavCategory cat) async {
  ...
  Future<void> loadPage(int page) async {
    ...
    try {
      final pageData = await NjavApiService.fetchVideos(
        page: page,
