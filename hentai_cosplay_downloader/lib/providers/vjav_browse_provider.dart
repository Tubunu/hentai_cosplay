...
class VjavBrowseProvider extends ChangeNotifier {
  ...
  VjavCategory _currentCategory = VjavCategory.latest;
  ...
  VjavCategory get currentCategory => _currentCategory;
  ...
  VjavBrowseProvider({bool autoLoad = true}) {
    if (autoLoad) {
      loadPage(1);
    }
  }

  Future<void> setCategory(VjavCategory cat) async {
  ...
  Future<void> loadPage(int page) async {
    ...
    try {
      final pageData = await VjavApiService.fetchVideos(
        page: page,
