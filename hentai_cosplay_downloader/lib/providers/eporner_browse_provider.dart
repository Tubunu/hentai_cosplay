...
class EpornerBrowseProvider extends ChangeNotifier {
  ...
  EpornerCategory _currentCategory = EpornerCategory.topWeekly;
  ...
  EpornerCategory get currentCategory => _currentCategory;
  ...
  Future<void> loadPage(int page) async {
    ...
    try {
      final response = await EpornerApiService.fetchPageData(
        page: page,
      ...
      if (response != null) {
        ...
        _errorMessage = '获取 EPorner 列表失败，请检查网络或配置代理';
      }
    } catch (e) {
      if (requestId != _currentRequestId) return;
  ...
  void switchCategory(EpornerCategory category) {
