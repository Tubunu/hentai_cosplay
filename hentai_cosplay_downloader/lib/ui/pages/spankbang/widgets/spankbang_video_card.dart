...
class SpankbangVideoCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final category = item.tags.isNotEmpty ? item.tags.first : 'SpankBang';
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      const Icon(CupertinoIcons.film_fill, size: 11, color: themeColor),
                      const SizedBox(width: 4),
                      Expanded(
                        child: Text(
                          item.author.isNotEmpty ? item.author : 'SpankBang',
                          maxLines: 1,
                          overflow: TextOverflow.ellipsis,
                          style: TextStyle(
                            fontSize: 11,
                      ...
                      GestureDetector(
                        onTap: () {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text('已添加 "${item.title}" 到视频下载队列'),
