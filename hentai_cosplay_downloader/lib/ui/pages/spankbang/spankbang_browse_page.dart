...
import 'spankbang_detail_page.dart';
import 'widgets/spankbang_video_card.dart';

class SpankbangBrowsePage extends StatefulWidget {
  const SpankbangBrowsePage({super.key});

  @override
  State<SpankbangBrowsePage> createState() => _SpankbangBrowsePageState();
}

class _SpankbangBrowsePageState extends State<SpankbangBrowsePage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final prov = context.read<SpankbangBrowseProvider>();
  ...
  void _showJumpPageDialog(BuildContext context, SpankbangBrowseProvider provider) {
    int selected = provider.currentPage;
    showDialog(
      context: context,
      builder: (ctx) {
        final isDark = Theme.of(context).brightness == Brightness.dark;
        const themeColor = Color(0xFF00E676);
        return AlertDialog(
  ...
  Widget build(BuildContext context) {
    final provider = context.watch<SpankbangBrowseProvider>();
    final isDark = Theme.of(context).brightness == Brightness.dark;
    const themeColor = Color(0xFF00E676);
                      ...
                      child: Row(
                        children: [
                          ...
                          RandomActionButton.video(
                            videoSite: VideoSiteType.spankbang,
                            isCapsule: true,
                            color: themeColor,
                          ),
                          const SizedBox(width: 8),
                  ...
                  SliverToBoxAdapter(
                    child: SizedBox(
                      ...
                      child: ListView(
                        ...
                        children: SpankbangCategory.values.map((cat) {
                        ...
                        child: Row(
                          children: [
                            ...
                            ElevatedButton(
                              ...
                              child: const Text('下载选中', style: TextStyle(fontSize: 12, color: Colors.black)),
                            ),
                          ],
                        ),
                      ),
                      ...
                      sliver: SliverGrid(
                        ...
                        delegate: SliverChildBuilderDelegate(
                          (context, index) {
                            ...
                            return SpankbangVideoCard(
                              item: item,
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (_) => SpankbangDetailPage(item: item),
                                  ),
                                );
                              },
                            );
