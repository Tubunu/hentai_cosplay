...
class SpankbangDetailPage extends StatefulWidget {
  final VideoItem item;

  const SpankbangDetailPage({super.key, required this.item});

  @override
  State<SpankbangDetailPage> createState() => _SpankbangDetailPageState();
}

class _SpankbangDetailPageState extends State<SpankbangDetailPage> {
  ...
  Future<void> _resolveDetail() async {
    ...
    try {
      final resolved = await SpankbangApiService.resolveVideoDetail(_item);
      if (mounted) {
        setState(() {
          _item = resolved;
          _isLoading = false;
