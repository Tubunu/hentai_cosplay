...
import '../../../providers/pornhub_author_provider.dart';
...
class PornhubAuthorPage extends StatelessWidget {
  final String authorName;
  final String? authorUrl;

  const PornhubAuthorPage({
    super.key,
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => PornhubAuthorProvider(
        authorName: authorName,
        authorUrl: authorUrl,
      )..loadPage(1),
      child: const _PornhubAuthorPageView(),
    );
  }
}

class _PornhubAuthorPageView extends StatefulWidget {
  const _PornhubAuthorPageView();

  @override
  State<_PornhubAuthorPageView> createState() => _PornhubAuthorPageViewState();
}

class _PornhubAuthorPageViewState extends State<_PornhubAuthorPageView> {
  ...
  void _showJumpPageDialog(BuildContext context, PornhubAuthorProvider provider) {
  ...
  @override
  Widget build(BuildContext context) {
    final provider = context.watch<PornhubAuthorProvider>();
    final isDark = Theme.of(context).brightness == Brightness.dark;
    const themeColor = Color(0xFFFF9900);
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                gradient: const LinearGradient(
                                  colors: [Color(0xFFFF9900), Color(0xFFFFB300)],
                                  begin: Alignment.topLeft,
                                  end: Alignment.bottomRight,
                                ),
                                boxShadow: [
                  ...
                  SliverToBoxAdapter(
                    child: SizedBox(
                      ...
                      child: ListView(
                        ...
                        children: PornhubSortOrder.values.map((sort) {
                          final isSelected = provider.sortOrder == sort;
                          return _buildChip(
                            label: sort.label,
