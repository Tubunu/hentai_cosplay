...
class NucosplayDetailPage extends StatefulWidget {
  final AlbumItem item;

  const NucosplayDetailPage({super.key, required this.item});

  @override
  State<NucosplayDetailPage> createState() => _NucosplayDetailPageState();
}

class _NucosplayDetailPageState extends State<NucosplayDetailPage> {
  ...
  Future<void> _loadDetail() async {
    ...
    try {
      final detailed = await NucosplayApiService.fetchAlbumDetail(_item);
