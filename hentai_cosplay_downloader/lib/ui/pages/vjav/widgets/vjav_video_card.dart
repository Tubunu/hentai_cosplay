...
class VjavVideoCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isSelected = context.select<VjavBrowseProvider, bool>((p) => p.isSelected(item));
    final isSelectionMode = context.select<VjavBrowseProvider, bool>((p) => p.isSelectionMode);
    ...
    return BouncingButton(
      onTap: () {
        if (isSelectionMode) {
          context.read<VjavBrowseProvider>().toggleItemSelection(item);
        } else {
          onTap();
        }
      },
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      const Spacer(),
                      if (item.rawData['rating'] != null && item.rawData['rating'].toString() != '0')
                        Row(
                          children: [
                            const Icon(CupertinoIcons.star_fill, size: 11, color: Colors.amber),
