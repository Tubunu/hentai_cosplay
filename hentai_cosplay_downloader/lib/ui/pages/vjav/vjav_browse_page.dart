...
import 'vjav_detail_page.dart';
import 'widgets/vjav_video_card.dart';

class VjavBrowsePage extends StatefulWidget {
  const VjavBrowsePage({super.key});

  @override
  State<VjavBrowsePage> createState() => _VjavBrowsePageState();
}

class _VjavBrowsePageState extends State<VjavBrowsePage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final provider = context.read<VjavBrowseProvider>();
  ...
  Widget build(BuildContext context) {
    ...
    final provider = context.watch<VjavBrowseProvider>();
                    ...
                    SliverToBoxAdapter(
                      child: Container(
                        ...
                        child: ListView.separated(
                          ...
                          itemCount: VjavCategory.values.length,
                          separatorBuilder: (_, __) => const SizedBox(width: 8),
                          itemBuilder: (context, idx) {
                            final cat = VjavCategory.values[idx];
                      ...
                      sliver: SliverGrid(
                        ...
                        delegate: SliverChildBuilderDelegate(
                          (context, index) {
                            ...
                            return VjavVideoCard(
                              item: item,
                              onTap: () {
                                Navigator.of(context).push(
                                  CupertinoPageRoute(
                                    builder: (_) => VjavDetailPage(item: item),
                                  ),
                                );
                              },
                            );
