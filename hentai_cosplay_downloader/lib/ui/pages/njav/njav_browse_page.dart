...
import 'njav_detail_page.dart';
import 'widgets/njav_video_card.dart';

class NjavBrowsePage extends StatefulWidget {
  const NjavBrowsePage({super.key});

  @override
  State<NjavBrowsePage> createState() => _NjavBrowsePageState();
}

class _NjavBrowsePageState extends State<NjavBrowsePage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final provider = context.read<NjavBrowseProvider>();
  ...
  Widget build(BuildContext context) {
    ...
    final provider = context.watch<NjavBrowseProvider>();
                    ...
                    SliverToBoxAdapter(
                      child: Container(
                        ...
                        child: ListView.separated(
                          ...
                          itemCount: NjavCategory.values.length,
                          separatorBuilder: (_, __) => const SizedBox(width: 8),
                          itemBuilder: (context, idx) {
                            final cat = NjavCategory.values[idx];
                      ...
                      sliver: SliverGrid(
                        ...
                        delegate: SliverChildBuilderDelegate(
                          (context, index) {
                            ...
                            return NjavVideoCard(
                              item: item,
                              onTap: () {
                                Navigator.of(context).push(
                                  CupertinoPageRoute(
                                    builder: (_) => NjavDetailPage(item: item),
                                  ),
                                );
                              },
                            );
