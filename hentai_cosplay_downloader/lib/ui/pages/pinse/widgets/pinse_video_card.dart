...
class PinseVideoCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const themeColor = Color(0xFFFF8C00);
    ...
    final tag = isHD ? 'HD' : (item.tags.isNotEmpty ? item.tags.first : '品色');
    ...
    return UnifiedMediaCard(
      ...
      heroTag: 'pinse_cover_${item.slug}_${item.detailUrl}',
      onTap: () {
        if (isSelectionMode) {
