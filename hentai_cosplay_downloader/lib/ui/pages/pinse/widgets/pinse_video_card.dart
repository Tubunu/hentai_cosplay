...
class PinseVideoCard extends StatelessWidget {
  final VideoItem item;
  final VoidCallback onTap;

  const PinseVideoCard({
    super.key,
    required this.item,
    required this.onTap,
  });
  ...
  Widget build(BuildContext context) {
    ...
    final isSelected = context.select<PinseBrowseProvider, bool>((p) => p.isSelected(item));
    final isSelectionMode = context.select<PinseBrowseProvider, bool>((p) => p.isSelectionMode);
    ...
    final isHD = item.tags.contains('HD') || item.views == '高清';

    return BouncingButton(
      onTap: () {
        if (isSelectionMode) {
          context.read<PinseBrowseProvider>().toggleItemSelection(item);
        } else {
          onTap();
        }
      },
              ...
              child: Stack(
                ...
                children: [
                  item.coverUrl != null && item.coverUrl!.isNotEmpty
                      ...
                      : Container(
                          color: isDark ? const Color(0xFF2C2C2E) : const Color(0xFFE5E5EA),
                          child: const Icon(CupertinoIcons.play_rectangle_fill, color: Colors.grey),
                        ),
                  ...
                  if (isSelectionMode)
                    Positioned(
                      ...
                      child: Container(
                        decoration: BoxDecoration(
                          color: isSelected ? const Color(0xFFFF8C00) : Colors.black45,
                          shape: BoxShape.circle,
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      const Icon(CupertinoIcons.person_fill, size: 11, color: Color(0xFFFF8C00)),
