...
import 'thothub_detail_page.dart';
import 'widgets/thothub_video_card.dart';

class ThothubBrowsePage extends StatefulWidget {
  const ThothubBrowsePage({super.key});

  @override
  State<ThothubBrowsePage> createState() => _ThothubBrowsePageState();
}

class _ThothubBrowsePageState extends State<ThothubBrowsePage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final provider = context.read<ThothubBrowseProvider>();
  ...
  Widget build(BuildContext context) {
    ...
    final provider = context.watch<ThothubBrowseProvider>();
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: ListView.separated(
                              ...
                              itemCount: ThothubCategory.values.length,
                              separatorBuilder: (_, __) => const SizedBox(width: 8),
                              itemBuilder: (context, index) {
                                final cat = ThothubCategory.values[index];
                      ...
                      sliver: SliverGrid(
                        ...
                        delegate: SliverChildBuilderDelegate(
                          (context, index) {
                            ...
                            return ThothubVideoCard(
                              item: item,
                              onTap: () {
                                Navigator.push(
                                  context,
                                  CupertinoPageRoute(
                                    builder: (_) => ThothubDetailPage(item: item),
                                  ),
                                );
                              },
                            );
                          ...
                          onPressed: provider.selectedCount > 0
                              ? () {
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text('已添加 $count 个视频到下载队列'),
                                      backgroundColor: themeColor,
