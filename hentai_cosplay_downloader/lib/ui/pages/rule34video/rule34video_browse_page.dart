...
import 'rule34video_detail_page.dart';
import 'widgets/rule34video_card.dart';

class Rule34VideoBrowsePage extends StatefulWidget {
  const Rule34VideoBrowsePage({super.key});

  @override
  State<Rule34VideoBrowsePage> createState() => _Rule34VideoBrowsePageState();
}

class _Rule34VideoBrowsePageState extends State<Rule34VideoBrowsePage> {
  ...
  void _showJumpPageDialog(BuildContext context, Rule34VideoBrowseProvider provider) {
  ...
  Widget build(BuildContext context) {
    final provider = context.watch<Rule34VideoBrowseProvider>();
    final isDark = Theme.of(context).brightness == Brightness.dark;
    const themeColor = Color(0xFFFF6B35);
            ...
            RefreshIndicator(
              ...
              child: CustomScrollView(
                ...
                slivers: [
                  ...
                  SliverToBoxAdapter(
                    child: SizedBox(
                      ...
                      child: ListView.separated(
                        ...
                        itemCount: Rule34VideoCategory.values.length,
                        separatorBuilder: (_, __) => const SizedBox(width: 8),
                        itemBuilder: (context, index) {
                          final cat = Rule34VideoCategory.values[index];
                          final isSelected = !provider.isSearchActive &&
                              !provider.isTagActive &&
                              !provider.isArtistActive &&
                  ...
                  if (provider.isSearchActive || provider.isTagActive || provider.isArtistActive)
                    SliverToBoxAdapter(
                      child: Padding(
                      ...
                      sliver: SliverGrid(
                        ...
                        delegate: SliverChildBuilderDelegate(
                          (context, index) {
                            ...
                            return Rule34VideoCard(
                              item: item,
                              onTap: () {
                                Navigator.push(
                                  context,
                                  CupertinoPageRoute(
                                    builder: (_) => Rule34VideoDetailPage(item: item),
                                  ),
                                );
                              },
                            );
