...
class PixibbAlbumCard extends StatelessWidget {
  final AlbumItem item;
  final VoidCallback onTap;

  const PixibbAlbumCard({
    super.key,
    required this.item,
    required this.onTap,
  });
  ...
  Widget build(BuildContext context) {
    ...
    final isSelected = context.select<PixibbBrowseProvider, bool>((p) => p.isSelected(item));
    ...
    return BouncingButton(
      onTap: () {
        if (isSelectionMode) {
          context.read<PixibbBrowseProvider>().toggleItemSelection(item);
        } else {
          onTap();
        }
      },
            ...
            Expanded(
              child: Stack(
                ...
                children: [
                  ...
                  // Top-Right: Selection Checkbox or Download Status Badge
                  if (isSelectionMode)
                    Positioned(
                      top: 8,
                      right: 8,
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          item.author.isNotEmpty ? item.author : 'PixiBB',
                          maxLines: 1,
                          overflow: TextOverflow.ellipsis,
                          style: TextStyle(
                            fontSize: 11,
