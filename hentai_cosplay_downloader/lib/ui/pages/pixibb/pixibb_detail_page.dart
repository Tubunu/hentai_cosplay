...
class _PixibbDetailPageState extends State<PixibbDetailPage> {
  ...
  void _openGallery(int initialIndex) {
    ...
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (_) => _PixibbGalleryViewer(
...
class _PixibbGalleryViewer extends StatefulWidget {
  final List<String> imageUrls;
  final int initialIndex;
  final String title;

  const _PixibbGalleryViewer({
  ...
  @override
  State<_PixibbGalleryViewer> createState() => _PixibbGalleryViewerState();
}

class _PixibbGalleryViewerState extends State<_PixibbGalleryViewer> {
