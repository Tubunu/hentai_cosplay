...
import 'cosplayporntube_detail_page.dart';
import 'widgets/cosplayporntube_video_card.dart';

class CosplayporntubeBrowsePage extends StatefulWidget {
  const CosplayporntubeBrowsePage({super.key});

  @override
  State<CosplayporntubeBrowsePage> createState() => _CosplayporntubeBrowsePageState();
}

class _CosplayporntubeBrowsePageState extends State<CosplayporntubeBrowsePage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final provider = context.read<CosplayporntubeBrowseProvider>();
  ...
  Widget build(BuildContext context) {
    ...
    final provider = context.watch<CosplayporntubeBrowseProvider>();
                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                              hintText: '搜索 CosplayPornTube (如 Tifa, Naruto, 2B)...',
                              hintStyle: TextStyle(
                                fontSize: 12,
                        ...
                        SingleChildScrollView(
                          ...
                          child: Row(
                            children: [
                              // Categories (Trending, Newest, Popular)
                              ...CosplayporntubeCategory.values.map((cat) {
                    ...
                    sliver: SliverGrid(
                      ...
                      delegate: SliverChildBuilderDelegate(
                        (context, index) {
                          ...
                          return CosplayporntubeVideoCard(
                            item: item,
                            onTap: () {
                              Navigator.push(
                                context,
                                CupertinoPageRoute(
                                  builder: (_) => CosplayporntubeDetailPage(item: item),
                                ),
                              );
                            },
                          );
