...
import 'hqporner_detail_page.dart';
import 'widgets/hqporner_video_card.dart';

class HqpornerBrowsePage extends StatefulWidget {
  const HqpornerBrowsePage({super.key});

  @override
  State<HqpornerBrowsePage> createState() => _HqpornerBrowsePageState();
}

class _HqpornerBrowsePageState extends State<HqpornerBrowsePage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final prov = context.read<HqpornerBrowseProvider>();
  ...
  void _showJumpPageDialog(BuildContext context, HqpornerBrowseProvider provider) {
  ...
  Widget build(BuildContext context) {
    final provider = context.watch<HqpornerBrowseProvider>();
    final isDark = Theme.of(context).brightness == Brightness.dark;
    const themeColor = Color(0xFFFF5722);
                      ...
                      child: Row(
                        children: [
                            ...
                            child: Container(
                              ...
                              child: TextField(
                                ...
                                decoration: InputDecoration(
                                  hintText: '搜索 HQPorner 1080P/4K超清视频...',
                                  hintStyle: TextStyle(
                                    fontSize: 12.5,
                          ...
                          RandomActionButton.video(
                            videoSite: VideoSiteType.hqporner,
                            isCapsule: true,
                            color: themeColor,
                          ),
                          const SizedBox(width: 8),
                  ...
                  SliverToBoxAdapter(
                    child: SizedBox(
                      ...
                      child: ListView(
                        ...
                        children: HqpornerCategory.values.map((cat) {
                      ...
                      sliver: SliverGrid(
                        ...
                        delegate: SliverChildBuilderDelegate(
                          (context, index) {
                            ...
                            return HqpornerVideoCard(
                              item: item,
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (_) => HqpornerDetailPage(item: item),
                                  ),
                                );
                              },
                            );
