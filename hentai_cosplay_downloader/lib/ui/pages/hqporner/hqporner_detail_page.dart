...
class HqpornerDetailPage extends StatefulWidget {
  final VideoItem item;

  const HqpornerDetailPage({super.key, required this.item});

  @override
  State<HqpornerDetailPage> createState() => _HqpornerDetailPageState();
}

class _HqpornerDetailPageState extends State<HqpornerDetailPage> {
  ...
  Future<void> _resolveDetail() async {
    ...
    try {
      final resolved = await HqpornerApiService.resolveVideoDetail(_item);
      if (mounted) {
        setState(() {
          _item = resolved;
          _isLoading = false;
