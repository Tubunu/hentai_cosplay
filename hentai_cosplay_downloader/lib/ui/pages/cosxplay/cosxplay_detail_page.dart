...
class CosxplayDetailPage extends StatefulWidget {
  final VideoItem item;

  const CosxplayDetailPage({super.key, required this.item});

  @override
  State<CosxplayDetailPage> createState() => _CosxplayDetailPageState();
}

class _CosxplayDetailPageState extends State<CosxplayDetailPage> {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (mounted) {
        context.read<BrowsingHistoryProvider>().recordVideo(
          ...
          siteKey: 'cosxplay',
          siteName: 'CosXPlay',
          siteColor: const Color(0xFFE91E63),
        );
      }
    });
  }
  ...
  Future<void> _resolveDetail() async {
    ...
    try {
      final resolved = await CosxplayApiService.resolveVideoDetail(_item);
      if (mounted) {
        setState(() {
          _item = resolved;
          _isLoading = false;
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Buttons Row (Play, Download, Web Play)
                      Row(
                        children: [
                          Expanded(
