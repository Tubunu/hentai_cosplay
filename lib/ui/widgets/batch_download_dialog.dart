  ...
  void _submit() async {
    ...
    if (start > end) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('起始页码不能大于结束页码')),
      );
      return;
    }
    ...
    downloadProv.addPageRange(start, end);
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('正在批量抓取第 $start 到 $end 页并加入下载队列...'),
      ...
      child: FrostedGlass(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              '输入要批量抓取并下载的页码范围，应用将自动分页拉取所有图包并加入下载队列：',
              style: TextStyle(
                fontSize: 13,
